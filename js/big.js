...
window.addEventListener("load", function() {
  ...
  function resizeTo(slideContainer, width, height) {
    var slideDiv = slideContainer.firstChild;
    var titleImages = slideContainer.querySelectorAll('.title-image');
    var small = [].slice.call(slideContainer.getElementsByTagName('small'));
    var fontSize = height;
    ...
    [100, 50, 10, 2].forEach(function(step) {
      for (; fontSize > 0; fontSize -= step) {
        ...
        titleImages.forEach(function (e) {
          e.style.height = fontSize + "px";
        })
